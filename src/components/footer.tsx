    ...
    <footer className="border-t border-[var(--color-border)] py-10">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-6 text-center md:flex-row md:justify-between md:text-left">
        ...
        <div className="flex flex-col gap-1">
          <span className="text-sm font-semibold">Matt Wilson</span>
          <span className="text-xs text-[var(--color-muted)]">
            Senior Full Stack &amp; AI Engineer
          </span>
        </div>

        {/* Centre: site nav + social links */}
        ...
        <div className="flex flex-col gap-1 text-right">
          <span className="text-xs text-[var(--color-muted)]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[var(--color-foreground)] underline underline-offset-2"
            >
              Next.js
            </a>
          </span>
          <span className="text-xs text-[var(--color-muted)]">
            &copy; {currentYear} Matt Wilson. All rights reserved.
          </span>
        </div>
      </div>
    </footer>
